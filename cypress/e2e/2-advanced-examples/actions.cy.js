...
context("Actions", () => {
                    ...
                    it(".clear() - clears an input or textarea element", () => {
                                        ...
                                        cy.get(".action-clear").type(
                                                            "Clear this text",
                                        )
                                        cy.get(".action-clear").should(
                                                            "have.value",
                                                            "Clear this text",
                                        )
                    ...
                    it(".dblclick() - double click on a DOM element", () => {
                                        ...
                                        cy.get(".action-div").should(
                                                            "not.be.visible",
                                        )
                                        cy.get(".action-input-hidden").should(
                                                            "be.visible",
                                        )
                    })
                    ...
                    it(".rightclick() - right click on a DOM element", () => {
                                        ...
                                        cy.get(".rightclick-action-div").should(
                                                            "not.be.visible",
                                        )
                                        cy.get(
                    ...
                    it(".uncheck() - uncheck a checkbox element", () => {
                                        ...
                                        cy.get(
                                                            '.action-check [type="checkbox"][value="checkbox3"]',
                                        ).should("not.be.checked")
                    ...
                    it(".trigger() - trigger an event on a DOM element", () => {
                                        ...
                                        cy.get(".trigger-input-range").invoke(
                                                            "val",
                                                            25,
                                        )
                                        cy.get(".trigger-input-range").trigger(
                                                            "change",
                                        )
                    ...
                    it("cy.scrollTo() - scroll the window or element to a position", () => {
                                        ...
                                        cy.get("#scrollable-vertical").scrollTo(
                                                            250,
                                                            250,
                                        )
                                        ...
                                        cy.get("#scrollable-both").scrollTo(
                                                            "75%",
                                                            "25%",
                                        )
